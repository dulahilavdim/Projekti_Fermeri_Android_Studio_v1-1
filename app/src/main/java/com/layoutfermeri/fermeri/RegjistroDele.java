...
public class RegjistroDele extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regjistro_dele);
    ...
    public void ShtoTeDhena ()
    {
        btnRuaj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                {
                    boolean isInserted = myDb.insertDataDele(etShifra.getText().toString(), etEmri.getText().toString(),
                            etGjinia.getText().toString(), etNgjyra.getText().toString());
                    if (isInserted == true) {
                        Toast.makeText(RegjistroDele.this, "Regjistrimi i suksesshem", Toast.LENGTH_LONG).show();
                        etShifra.setText("");
                        etEmri.setText("");
                        etGjinia.setText("");
                        etNgjyra.setText("");
                    } else
                        Toast.makeText(RegjistroDele.this, "Regjistrimi i pasuksesshem", Toast.LENGTH_LONG).show();
                }
    ...
    public void viewAll()
    {
        btnShfaq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Cursor res = myDb.getAllDataDele();
                if (res.getCount() == 0) {
                    //show msg
